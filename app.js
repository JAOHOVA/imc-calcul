...
// Pour annuler le comportement par défaut de formulaire
function handleForm(e) {
    e.preventDefault();

    calculateBMI();
}
// Pour récupérer tous les inputs c'est pas du tableau
const inputs = document.querySelectorAll('input');
// Pour récupérer tous les inputs sous forme de tableau
// const inputs = [...document.querySelectorAll('input')];
